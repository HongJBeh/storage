    ...
    <body>
      ...
      <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="pt-3">
          <table class="table table-striped table-dark table-sm">
            ...
            <tbody>
              <?php
                ...
                if ($result = $con->query($sql))
                {
                    while ($row = $result->fetch_object())
                    {
                        printf('
                            ...
                            $row->EventID, // value for checkbox
                            $row->Event,
                            $row->Venue,
                            $row->Day,
                            $row->Time,
                ...
                printf('
                    <tr>
                    <td colspan = "6" class="p-3 text-success">
          ...
          <input type="button" value="Add Event" class="btn btn-success" onclick="location='addEventDB.php'">
        </div>
      </div>
