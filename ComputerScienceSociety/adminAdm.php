...
<html>  
    ...
    <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="pt-3">
        <table class="table table-striped table-dark table-md">
          ...
          <tbody>
              <?php
                    ...
                    while ($row = $result->fetch_object())
                    {
                        printf('
                            <tr class="align-middle text-center">
                                ...
                                <td class="p-2">%s</td>
                                <td>
                                <button type="button" class="btn btn-success m-1" name="edit"><a class="text-decoration-none text-white" href="editAdminDB.php?id=%s">Edit</a></button>
                                <button type="button" class="btn btn-danger m-1" name="delete"><a class="text-decoration-none text-white" href="delAdminDB.php?id=%s">Delete</a></button>
                                </td>
                            </tr>', 
                            $row->no, 
                            $row->adminName,
                ...
                printf('
                    <tr>
                    <td colspan = "5" class="p-3 text-success">
                        There are %d Admin record(s).
                    </td>
                    </tr>', $result->num_rows);
                }
        ...
        <button type="submit" class="btn btn-primary" name="submit"  onclick="location='addAdminDB.php'">Add admin</button>
