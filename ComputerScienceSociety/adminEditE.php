      ...
      <div class="pt-3">
        <table class="table table-striped table-dark table-sm">
            <thead>
                ...
                <th scope="col" class="p-2">Event</th>
                <th scope="col" class="p-2">Venue</th>
                <th scope="col" class="p-2">Day</th>
            ...
            <tbody>
              <?php
                    ...
                    while ($row = $result->fetch_object())
                    {
                        printf('
                            <tr>
                                ...
                                <td class="p-2">%s</td>
                                <td>
                                <button type="button" class="btn btn-success m-1" name="edit"><a class="text-decoration-none text-white" href="editEventDB.php?id=%s>">Edit</a></button>
                                <button type="button" class="btn btn-danger m-1" name="delete"><a class="text-decoration-none text-white" href="delEventDB.php?id=%s">Delete</a></button>
                                </td>
                            </tr>', 
                            $row->EventID, 
                            $row->Event,
                ...
                printf('
                    <tr>
                    <td colspan = "8" class="p-3 text-success">
                        There are %d event record(s).
                    </td>
                    </tr>', $result->num_rows);
                }
