    ...
    <header  class="p-3 text-bg-dark">
        <div class="container">
            <div class=" d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <li> 
                <a class="nav-link fs-5 pe-4 text-white link-primary" href="#">
                ...
                <li> <a class="nav-link fs-5 px-2 text-white link-primary" href="#">Event</a></li>
                <li> <a class="nav-link fs-5 px-2 text-white link-primary" href="#">Committee</a></li>  
                <li> <a class="nav-link fs-5 px-2 text-white link-primary" href="#">Volunteer</a></li>  
             </ul>
             ...
             <div class="text-end">
                <a class="nav-link px-2 text-white link-primary" href="#">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="#!" class="nav-link text-white link-primary ">Event</a>
            </li>
            <li>
              <a href="#!" class="nav-link text-white link-primary">Volunteer</a>
            </li>
          </ul>
        </div>
